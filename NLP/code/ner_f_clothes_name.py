...
word2vec = gensim.models.Word2Vec.load('./f_clothes_model50000_100_4')
...
vocab_to_idx, idx_to_vocab, idx_to_count = scan_vocabulary(
    comments, min_count=100, verbose=True)
...
f = open("f_clothes_name_ner_100_4.txt", 'w')
...
p_seed_list = ['스트라이프/Noun','가죽/Noun','코트/Noun','후드/Noun','티/Noun','모직/Noun','스판/Noun',
            ...
            '집업/Noun', '기모/Noun', '레이스/Noun', '원피스/Noun', '스커트/Noun', '캐시미어/Noun', '진주/Noun']
...
n_seed_list = ['실리콘/Noun', '럭셔리/Noun', '어깨/Noun', '라코스테/Noun', '유니클로/Noun', '인디안/Noun',
            '숏/Noun', '네이비/Noun', '블랙/Noun', '내셔널/Noun', '깨끗/Noun', '어린이집/Noun', '여름/Noun', '발렌시아/Noun', '바나나/Noun', '택있음/Noun',
            '인디고/Noun', '티나/Noun', '앤듀/Noun', '버핏/Noun', '이나/Noun']
