...
word2vec = gensim.models.Word2Vec.load('./it_all_model70000_50_8')
...
comments = read_data('./data/KT.txt')
comments = read_data('./data/LGU.txt')
comments += read_data('./data/notebook.txt')
comments += read_data('./data/tablet.txt')
comments += read_data('./data/notebook2.txt')
comments += read_data('./data/tablet4.txt')
...
f = open("it_color_ner_50_6.txt", 'w')

#아 기억났다 _는 버리는 변수명으로 잘 쓰인댔어
#seed_words 타입은 set이야 집합!!
p_seed_list = ['스그/Noun', '화이트/Noun', '검은색/Noun']
